...
---
Re-read the plan file and the fullspec document carefully — approach the plan as
...
- **Coverage gaps**: Does the plan address everything described in the fullspec?
  Compare the plan directly against the fullspec and add anything that was
  overlooked.
