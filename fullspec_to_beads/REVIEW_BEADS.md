...
---
Re-read the beads file carefully against the plan file. Look for:
...
- "Research beads" that exist solely to gather information for later beads. This is
  ...
  findings to one another. Research should happen during the fullspec_to_beads
  process and be baked into the relevant bead descriptions or the Codebase Notes
  section. If a research bead appears, fold its findings into the descriptions of
  the beads that need them (or into Codebase Notes), then remove it.
