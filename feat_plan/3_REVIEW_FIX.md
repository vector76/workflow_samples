...
---
Re-read the plan file (whose name was stated at the start of this workflow) and
the feature document carefully — approach the plan as if you are seeing it for
the first time.
...
with exactly:
<goto>4_CHECK_CONVERGENCE.md</goto>
