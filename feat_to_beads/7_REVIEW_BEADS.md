---
allowed_transitions:
  - { tag: goto, target: 8_CHECK_BEADS.md }
---
Review `bead_list.md` carefully against `plan.md`. Look for:
...
- "Research beads" that exist solely to gather information for later beads. This is
  ...
  findings to one another. Research should happen during the feat_to_beads process
